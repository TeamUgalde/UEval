...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { last_name: @professor.last_name, name: @professor.name, overall_score: @professor.overall_score }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { last_name: @professor.last_name, name: @professor.name, overall_score: @professor.overall_score }
    assert_redirected_to professor_path(assigns(:professor))
  end
